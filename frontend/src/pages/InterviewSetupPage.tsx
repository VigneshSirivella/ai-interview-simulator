      ...
      {selectedSection === "practice" && (
        <section className="bg-white dark:bg-[#121218] border border-slate-200 dark:border-slate-800 rounded-3xl p-3.5 sm:p-6 lg:p-8 shadow-2xl flex flex-col gap-6 sm:gap-8 w-full min-w-0">
          ...
          <div className="w-full min-w-0">
            {practiceMode === "one-on-one" ? (
              /* 1-TO-1 AI MOCK INTERVIEW SETUP */
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start w-full min-w-0">
                ...
                <div className="hidden lg:block lg:col-span-5 w-full min-w-0">
                  <div className="bg-gradient-to-br from-indigo-950/90 via-slate-900/95 to-purple-950/90 border-2 border-indigo-500/40 rounded-3xl p-3.5 sm:p-6 lg:p-7 shadow-2xl backdrop-blur-xl flex flex-col gap-4 sm:gap-5 relative overflow-hidden group transform transition-all duration-500 ease-out hover:-translate-y-1.5 hover:scale-[1.01] hover:shadow-[0_25px_60px_rgba(16,185,129,0.3)] hover:border-emerald-400/60 w-full min-w-0 box-border">
                    <div className="absolute -top-16 -right-16 w-48 h-48 bg-emerald-500/20 rounded-full blur-3xl group-hover:bg-emerald-500/30 transition-all duration-500 pointer-events-none" />
                    <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-indigo-500/25 rounded-full blur-3xl pointer-events-none" />
              ...
              /* TECHNICAL SKILL & LANGUAGE PRACTICE SETUP */
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start w-full min-w-0">
                <div className="lg:col-span-7 flex flex-col gap-6 w-full min-w-0">
                  <div className="bg-gradient-to-br from-purple-950/90 via-slate-900/95 to-indigo-950/90 border-2 border-purple-500/40 rounded-3xl p-4 sm:p-5 shadow-2xl backdrop-blur-xl flex items-center gap-3 relative overflow-hidden w-full min-w-0">
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-purple-500 via-fuchsia-500 to-pink-500 text-white flex items-center justify-center font-black shadow-lg shadow-purple-500/40 shrink-0">
                  ...
                  <div className="bg-gradient-to-br from-purple-950/90 via-slate-900/95 to-indigo-950/90 border-2 border-purple-500/40 rounded-3xl p-3.5 sm:p-7 shadow-2xl backdrop-blur-xl flex flex-col gap-5 sm:gap-6 relative overflow-hidden group transform transition-all duration-500 ease-out hover:-translate-y-1.5 hover:scale-[1.01] hover:shadow-[0_25px_60px_rgba(168,85,247,0.35)] hover:border-purple-400/80 w-full min-w-0 box-border">
                    ...
                    <div className="relative z-10 w-full min-w-0">
                      <label className="text-xs sm:text-sm font-black uppercase tracking-wide text-fuchsia-300 mb-2.5 flex items-center gap-2">
                        <Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-fuchsia-400 shrink-0" />
                        Target Company
                      </label>
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3 w-full min-w-0">
                        {COMPANIES.map((item) => (
                          <button
                            ...
                            className={`py-2.5 sm:py-3 px-2 sm:px-2.5 rounded-xl text-xs font-black border transition-all duration-200 cursor-pointer transform hover:-translate-y-0.5 hover:scale-105 active:scale-95 w-full min-w-0 truncate ${
                              company === item
                    ...
                    <div className="relative z-10 w-full min-w-0">
                      <label className="text-xs sm:text-sm font-black uppercase tracking-wide text-fuchsia-300 mb-2 flex items-center gap-2">
                        <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-fuchsia-400 shrink-0" />
                        Target Role
                      </label>
                      <select
                        value={role}
                        onChange={(event) => setRole(event.target.value)}
                        className="w-full p-3 sm:p-3.5 rounded-2xl border-2 border-purple-500/30 bg-slate-900/80 text-white text-xs sm:text-sm outline-none focus:border-fuchsia-400 focus:ring-2 focus:ring-fuchsia-400/40 transition-all cursor-pointer font-black min-w-0 box-border"
                      >
                        {ROLES.map((item) => (
                    ...
                    <div className="relative z-10 w-full min-w-0">
                      <label className="text-xs sm:text-sm font-black uppercase tracking-wide text-fuchsia-300 mb-1 flex items-center gap-2">
                        <Code2 className="w-4 h-4 sm:w-5 sm:h-5 text-fuchsia-400 shrink-0" />
                        Preferred Programming Languages
                      </label>
                      <p className="text-[11px] text-purple-300/70 mb-2.5 font-medium leading-relaxed">
                    ...
                    <div className="relative z-10 w-full min-w-0">
                      ...
                      <div className="grid grid-cols-3 gap-2.5 sm:gap-3 w-full min-w-0">
                        {["Easy", "Medium", "Hard"].map((item) => (
                          <button
                            type="button"
                            key={item}
                            onClick={() => setDifficulty(item)}
                            className={`py-2.5 sm:py-3 rounded-2xl text-xs sm:text-sm font-black border transition-all duration-200 cursor-pointer transform hover:-translate-y-0.5 hover:scale-105 active:scale-95 w-full min-w-0 truncate ${
                              difficulty === item
                    ...
                    <div className="relative z-10 w-full min-w-0">
                      <div className="flex justify-between items-center mb-2 w-full min-w-0 gap-2">
                        <label className="text-xs font-black uppercase tracking-wide text-fuchsia-300 flex items-center gap-2 shrink-0">
                          <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400 animate-pulse shrink-0" />
                          Total Questions
                        </label>
                        <span className="text-xs font-black text-white bg-gradient-to-r from-purple-600 to-fuchsia-600 px-3 py-1 rounded-full shadow-md border border-fuchsia-400/40 shrink-0">
                      ...
                      <input
                        ...
                        className="w-full accent-fuchsia-500 cursor-pointer h-2 bg-slate-800 rounded-lg min-w-0 box-border"
                      />
                    </div>

                    {resumeSkills.length > 0 && (
                      <div className="p-3.5 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 relative z-10 w-full min-w-0">
...
const LanguageSelect: React.FC<LanguageSelectProps> = ({
  ...
  return (
    <div className="w-full min-w-0">
      <label className="block text-xs sm:text-sm font-black text-fuchsia-200 mb-1.5 uppercase tracking-wide truncate">
        {label}
      </label>
      <select
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="w-full p-3 sm:p-3.5 rounded-2xl border-2 border-purple-500/30 bg-slate-900/90 text-white text-xs sm:text-sm font-bold outline-none focus:border-fuchsia-400 focus:ring-2 focus:ring-fuchsia-400/40 transition-all cursor-pointer min-w-0 box-border"
      >
