...
export const InterviewSetupPage: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl w-full mx-auto px-3 sm:px-5 md:px-6 lg:px-8 py-6 sm:py-8 lg:py-10 flex flex-col gap-8 overflow-x-hidden">
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-indigo-600 to-cyan-500 text-white flex items-center justify-center font-bold shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="pt-5 border-t border-indigo-500/20 flex items-center justify-between">
                <button
                  type="button"
      ...
      {selectedSection === "practice" && (
        <section className="bg-white dark:bg-[#121218] border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl flex flex-col gap-8">
          {/* Section Header */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 dark:border-slate-800/80 pb-5 gap-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-purple-600 text-white flex items-center justify-center font-bold shadow-lg shadow-purple-600/30 shrink-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <button
              ...
              className={`p-6 rounded-3xl border-2 text-left transition-all duration-300 flex items-center justify-between cursor-pointer relative overflow-hidden group transform hover:-translate-y-2 hover:scale-[1.02] active:scale-[0.98] ${
            ...
            >
              ...
              <div className="flex items-center gap-4 relative z-10">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black shrink-0 transition-transform duration-300 group-hover:scale-110 ${
                  practiceMode === "one-on-one"
              ...
              <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider transition-all duration-300 relative z-10 shrink-0 ${
                practiceMode === "one-on-one"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              {practiceMode === "one-on-one" ? (
                ...
                <>
                  <div className="relative p-6 sm:p-7 rounded-3xl bg-gradient-to-r from-indigo-900/80 via-purple-900/60 to-indigo-950 border-2 border-indigo-500/50 text-white shadow-2xl shadow-indigo-500/20 overflow-hidden backdrop-blur-xl group transform transition-all duration-500 ease-out hover:-translate-y-2 hover:scale-[1.015] hover:shadow-[0_25px_60px_rgba(99,102,241,0.35)] hover:border-indigo-400/80">
                    ...
                    <div className="relative z-10 flex flex-col gap-2.5">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 text-white flex items-center justify-center font-black shadow-lg shadow-purple-500/40 shrink-0 transition-transform duration-300 group-hover:scale-110">
                          <Sparkles className="w-5 h-5 text-white" />
                        </div>
                        <div>
                          <h3 className="text-lg sm:text-xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-indigo-100 to-purple-200">
                            1-to-1 AI Mock Interview
                          </h3>
                          <span className="text-[10px] font-black uppercase tracking-widest text-indigo-300 bg-indigo-500/25 px-2.5 py-0.5 rounded-full border border-indigo-400/30 inline-block mt-0.5">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
                      {[5, 10, 15, 20].map((count) => (
                        <button
                          ...
                          className={`py-4 px-4 rounded-2xl text-xs font-black border transition-all duration-300 cursor-pointer transform hover:-translate-y-1.5 hover:scale-[1.05] active:scale-[0.96] ${
                ...
                /* VIBRANT TECHNICAL SKILL & LANGUAGE PRACTICE SETUP BOX */
                <div className="bg-gradient-to-br from-purple-950/90 via-slate-900/95 to-indigo-950/90 border-2 border-purple-500/40 rounded-3xl p-6 sm:p-7 shadow-2xl backdrop-blur-xl flex flex-col gap-6 relative overflow-hidden group transform transition-all duration-500 ease-out hover:-translate-y-2 hover:scale-[1.015] hover:shadow-[0_25px_60px_rgba(168,85,247,0.35)] hover:border-purple-400/80">
                  ...
                  <div className="flex items-center gap-3 border-b border-purple-500/20 pb-4 relative z-10">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-fuchsia-300 bg-fuchsia-500/20 px-2.5 py-0.5 rounded-full border border-fuchsia-400/30 inline-block mt-0.5">
                  ...
                  <div className="relative z-10">
                    <label className="text-sm sm:text-base font-black uppercase tracking-wide text-fuchsia-300 mb-3 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                      {COMPANIES.map((item) => (
                        <button
                          ...
                          className={`py-3.5 px-3 rounded-xl text-sm sm:text-base font-black border transition-all duration-200 cursor-pointer transform hover:-translate-y-1 hover:scale-105 active:scale-95 ${
                            company === item
                  ...
                  {/* Target Role */}
                  <div className="relative z-10">
                    <label className="text-sm sm:text-base font-black uppercase tracking-wide text-fuchsia-300 mb-2 flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="w-full p-4 rounded-2xl border-2 border-purple-500/30 bg-slate-900/80 text-white text-sm sm:text-base outline-none focus:border-fuchsia-400 focus:ring-2 focus:ring-fuchsia-400/40 transition-all cursor-pointer font-black"
                    >
                      {ROLES.map((item) => (
                  ...
                  <div className="relative z-10">
                    <label className="text-sm sm:text-base font-black uppercase tracking-wide text-fuchsia-300 mb-1 flex items-center gap-2">
                      <Code2 className="w-5 h-5 text-fuchsia-400" />
                      Preferred Programming Languages
                    </label>
                    <p className="text-[11px] sm:text-xs text-purple-300/70 mb-3 font-medium">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {["Easy", "Medium", "Hard"].map((item) => (
                        <button
                          ...
                          className={`py-3.5 rounded-2xl text-sm sm:text-base font-black border transition-all duration-200 cursor-pointer transform hover:-translate-y-1 hover:scale-105 active:scale-95 ${
                            difficulty === item
                  ...
                  <div className="relative z-10">
                    <div className="flex justify-between items-center mb-2">
                      <label className="text-sm sm:text-base font-black uppercase tracking-wide text-fuchsia-300 flex items-center gap-2">
                        <span className="w-2.5 h-2.5 rounded-full bg-fuchsia-400 animate-pulse" />
                        Total Questions
                      </label>
                      <span className="text-sm font-black text-white bg-gradient-to-r from-purple-600 to-fuchsia-600 px-3.5 py-1 rounded-full shadow-md border border-fuchsia-400/40">
                  ...
                  {resumeSkills.length > 0 && (
                    <div className="p-4 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 relative z-10">
            ...
            {/* Right Column: Camera & Proctoring Configuration */}
            <div className="lg:col-span-5 flex flex-col gap-6">
              <div className="bg-gradient-to-br from-indigo-950/90 via-slate-900/95 to-purple-950/90 border-2 border-indigo-500/40 rounded-3xl p-6 sm:p-7 shadow-2xl backdrop-blur-xl flex flex-col gap-5 relative overflow-hidden group transform transition-all duration-500 ease-out hover:-translate-y-2 hover:scale-[1.015] hover:shadow-[0_25px_60px_rgba(16,185,129,0.3)] hover:border-emerald-400/60">
                {/* Glowing Background Accents */}
                ...
                <h3 className="text-base font-black text-white flex items-center justify-between border-b border-indigo-500/20 pb-4 relative z-10">
                  <span className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center border border-emerald-500/40 shadow-lg shadow-emerald-500/20 shrink-0">
                      <ShieldCheck className="w-5 h-5" />
                    </div>
                    <span>Optional Camera & AI Proctoring</span>
                  </span>
                  <span className="px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-emerald-500 to-cyan-500 text-white shadow-lg shadow-emerald-500/30 border border-cyan-200/30">
                    Proctoring AI
                  </span>
                </h3>

                <div className="p-4.5 rounded-2xl bg-gradient-to-r from-indigo-900/60 via-purple-900/40 to-slate-900/80 border border-indigo-400/40 text-indigo-100 shadow-xl shadow-indigo-500/10 relative z-10">
                  <p className="text-xs font-black text-white flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-cyan-300" />
                    Enable Camera Proctoring Analysis?
                  </p>
                  ...
                  <p className="mt-2 text-[11px] text-indigo-300/80 font-medium">
                ...
                <div className="grid grid-cols-2 gap-3.5 relative z-10">
                  <button
                    ...
                    className={`p-4.5 rounded-2xl border-2 text-left transition-all duration-300 cursor-pointer transform hover:-translate-y-1.5 hover:scale-[1.04] active:scale-[0.97] ${
                      cameraChoice === "disabled"
                        ? "border-slate-300 bg-gradient-to-br from-slate-800 to-slate-900 text-white shadow-2xl shadow-slate-900/80 ring-2 ring-slate-400/50 scale-[1.02]"
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-slate-800/80 flex items-center justify-center mb-2.5 border border-slate-700/60">
                      <CameraOff className={`w-5 h-5 ${cameraChoice === "disabled" ? "text-white" : "text-slate-400"}`} />
                    </div>
                    <p className={`text-xs font-black ${cameraChoice === "disabled" ? "text-white" : "text-slate-300"}`}>
                      Without Camera
                    </p>
                    <span className="text-[10px] text-slate-400 block mt-0.5 font-medium">Standard audio mode</span>
                  </button>
                  ...
                  <button
                    ...
                    className={`p-4.5 rounded-2xl border-2 text-left transition-all duration-300 cursor-pointer transform hover:-translate-y-1.5 hover:scale-[1.04] active:scale-[0.97] ${
                      cameraChoice === "enabled"
                        ? "border-emerald-400 bg-gradient-to-br from-emerald-950/90 via-teal-900/70 to-indigo-950 text-white shadow-2xl shadow-emerald-500/40 ring-2 ring-emerald-400/60 scale-[1.02]"
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-emerald-500/20 text-emerald-400 border border-emerald-500/40 flex items-center justify-center mb-2.5 shadow-md shadow-emerald-500/20">
                      <Camera className="w-5 h-5 text-emerald-300" />
                    </div>
                    <p className={`text-xs font-black ${cameraChoice === "enabled" ? "text-emerald-200" : "text-emerald-300"}`}>
                      Enable Camera
                    </p>
                    <span className="text-[10px] text-emerald-300/80 block mt-0.5 font-medium">Full AI proctoring</span>
                  </button>
                </div>
                ...
                {cameraChoice === "enabled" && cameraPermissionGranted && (
                  <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-900/90 to-teal-900/80 border-2 border-emerald-400 text-white text-xs flex items-center gap-3 font-bold shadow-xl shadow-emerald-500/20 relative z-10">
                    <div className="w-7 h-7 rounded-xl bg-emerald-500/30 text-emerald-300 flex items-center justify-center shrink-0 border border-emerald-400/40">
