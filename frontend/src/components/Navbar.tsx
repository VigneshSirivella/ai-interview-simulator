...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: "Mock Interview", path: "/setup", icon: PlayCircle },
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-[#0F0F12]/80 backdrop-blur-md transition-colors">
      <div className="max-w-7xl w-full mx-auto px-3 sm:px-5 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 sm:gap-2.5 group min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 shrink-0 rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-md shadow-indigo-500/20 group-hover:scale-105 transition-transform">
              <Sparkles className="w-5 h-5" />
            </div>
            <div>
              <span className="text-base sm:text-lg font-extrabold bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-800 dark:from-white dark:via-indigo-200 dark:to-slate-200 bg-clip-text text-transparent tracking-tight whitespace-nowrap">
                AI Interview
              </span>
              <span className="hidden sm:block text-xs font-semibold text-indigo-600 dark:text-indigo-400 -mt-1">
                SIMULATOR
              </span>
            </div>
          </Link>
